...
KEY INSIGHTS:
- Original formula had NEGATIVE correlation (rejected)
- Players who improved recently tend to REGRESS
- Underperformers (xwOBA > wOBA) bounce back
- Young players with high deviation have most upside
"""
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        response = {"status": "healthy", "service": "MADDUX API"}
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Execute query
            result = execute_query(question, api_key)
